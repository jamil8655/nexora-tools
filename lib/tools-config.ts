...
export const TOOLS_LIST: ToolDefinition[] = [
  ...
  },
  {
    ...
    shortDesc: 'Generate dummy placeholder text for design mockups, wireframes, and UI testing.',
    fullDesc: 'Quickly produce paragraphs, sentences, and words of standard Lorem Ipsum placeholder text.',
    category: 'text',
    icon: 'AlignLeft',
    popular: true,
    isClientSide: true,
    ...
    outputExtension: 'txt',
    outputMimeType: 'text/plain',
    tags: ['lorem ipsum', 'dummy text', 'placeholder text', 'mock text'],
  },
];
